...
sp = splitter('splitter', num_out=1)
...
btes.add_conns(fc_pu, pu_sp, sp_bhe1, bhe1_mg, mg_cons, cons_fc)
...
fc_pu.set_attr(p=inflow_head, m=0.2, fluid={'water': 1})
