...
k_s = 2.82 # heat conductivity of soil. Unit W/m/K
rho_s = 1120 #kg/m3
c_s = 3.2e6  # heat capacity of soil. Unit J/m3/K
alpha_s = k_s / c_s
...
w = 0.2e-3  # unit m3/sec
# heat capacity of circulating water
c_f = 4400*1000  # unit J/K/m3
# set dimensions and properties of U-tube pipe
d_po = 0.0334  # outer pipe diameter, unit m
d_pi = 0.02733  # inner pipe diameter, unit m
